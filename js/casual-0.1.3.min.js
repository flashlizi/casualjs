...
100;a.prototype.getCurrentWidth=function(){return Math.abs(this.width*this.scaleX)};a.prototype.getCurrentHeight=function(){return Math.abs(this.height*this.scaleY)};a.prototype.getStage=function(){if(this.stage)return this.stage;for(var b=this;b.parent;)b=b.parent;return b instanceof casual.Stage?this.stage=b:null};a.prototype.localToGlobal=function(b,a){var e=this.getConcatenatedMatrix();if(null==e)return{x:0,y:0};var f=new casual.Matrix(1,0,0,1,b,a);f.concat(e);return{x:f.tx,y:f.ty}};a.prototype.globalToLocal=
function(b,a){var e=this.getConcatenatedMatrix();if(null==e)return{x:0,y:0};e.invert();var f=new casual.Matrix(1,0,0,1,b,a);f.concat(e);return{x:f.tx,y:f.ty}};a.prototype.localToTarget=function(b,a,e){b=this.localToGlobal(b,a);return e.globalToLocal(b.x,b.y)};a.prototype.getConcatenatedMatrix=function(){for(var b=new casual.Matrix,a=this;null!=a&&!(b.concatTransform(a.x,a.y,a.scaleX,a.scaleY,a.rotation,a.regX,a.regY),a instanceof casual.Stage);a=a.parent);return b};a.prototype._transform=function(b,
a){if(a){var e=this.localToGlobal(0,0);0==e.x&&0==e.y||b.translate(e.x,e.y)}else b.translate(this.x,this.y);0<this.rotation%360&&b.rotate(this.rotation%360/180*Math.PI);1==this.scaleX&&1==this.scaleY||b.scale(this.scaleX,this.scaleY);a||b.translate(-this.regX,-this.regY);b.globalAlpha*=this.alpha};a.prototype._render=function(b,a,e){!this.visible||0>=this.alpha||(b.save(),a||this._transform(b,e),this.render(b),b.restore())};a.prototype.render=function(b){};a.prototype.hitTestPoint=function(b,c,e,
...
a.prototype.getChildByName=function(b){for(var a=0,c=this.children.length;a<c;a++){var e=this.children[a];if(e.name==b)return e}return null};a.prototype.getChildAt=function(b){return 0>b||b>=this.children.length?null:this.children[b]};a.prototype.getChildIndex=function(b){return this.children.indexOf(b)};a.prototype.setChildIndex=function(b,a){if(b.parent==this){var c=this.children.indexOf(b);a!=c&&(this.children.splice(c,1),this.children.splice(a,0,b))}};a.prototype.contains=function(b){return-1!=
this.getChildIndex(b)};a.prototype.getNumChildren=function(){return this.children.length};a.prototype.getObjectUnderPoint=function(b,d,c,e,f){if(f)var g=[];for(var k=this.children.length-1;0<=k;k--){var h=this.children[k];if(null!=h&&h.mouseEnabled&&h.visible&&!(0>=h.alpha))if(h instanceof a&&h.mouseChildren&&0<h.getNumChildren()){var l=h.getObjectUnderPoint(b,d,c,e,f);if(l)if(f)0<l.length&&(g=g.concat(l));else return l;else if(h.hitTestPoint(b,d,c,e))if(f)g.push(h);else return h}else if(h.hitTestPoint(b,
d,c,e))if(f)g.push(h);else return h}return f?g:null};a.prototype.render=function(b){for(var a=0,c=this.children.length;a<c;a++)this.children[a]._render(b)}})();(function(){var a=function(b){if(null==b)throw Error("Context can't be null!");casual.DisplayObjectContainer.call(this);this.name=NameUtil.createUniqueName("Stage");this.context=b;this.canvas=b.canvas;this.mouseY=this.mouseX=0;this.usePixelTrace=this.traceMouseTarget=!0;this.dragTarget=this.mouseTarget=null;this._frameRate=this._dragMouseY=this._dragMouseX=0;this._pauseInNextFrame=this._paused=!1;this.__intervalID=null;this.setFrameRate(20);casual.StageEvent.supportTouch()?(this.canvas.addEventListener("touchstart",
...
casual.Stage=a;a.prototype.setPaused=function(b,a){this._paused!=b&&(this._paused=b,this._pauseInNextFrame=a||!1)};a.prototype.getPaused=function(){return this._paused};a.prototype.getFrameRate=function(){return this._frameRate};a.prototype.setFrameRate=function(b){this._frameRate!=b&&(this._frameRate=b,null!=this.__intervalID&&clearInterval(this.__intervalID),this.__intervalID=setInterval(casual.delegate(this.__enterFrame,this),1E3/this._frameRate))};a.prototype.__touchHandler=function(b){var a=
...
"mouseup"}a=casual.copy(b,casual.StageEvent,a);if(this.mouseTarget&&this.mouseTarget.onMouseEvent&&(this.mouseTarget.onMouseEvent(a),"mouseup"==a.type))this.mouseTarget.onMouseEvent(casual.copy(b,casual.StageEvent,{type:"mouseout"}));this.dispatchEvent(a);b.preventDefault();b.stopPropagation()};a.prototype.__mouseHandler=function(b){this.mouseX=b.pageX-this.canvas.offsetLeft;this.mouseY=b.pageY-this.canvas.offsetTop;this.traceMouseTarget&&"mousemove"==b.type&&this.__getMouseTarget(b);var a=casual.copy(b,
casual.StageEvent);a.target=a.currentTarget=this.mouseTarget||this;a.mouseX=this.mouseX;a.mouseY=this.mouseY;if(this.mouseTarget&&this.mouseTarget.onMouseEvent)this.mouseTarget.onMouseEvent(a);this.setCursor(this.mouseTarget&&this.mouseTarget.useHandCursor?"pointer":"");this.dispatchEvent(a);b.preventDefault();b.stopPropagation()};a.prototype.__getMouseTarget=function(b){var a=this.getObjectUnderPoint(this.mouseX,this.mouseY,this.usePixelTrace),c=this.mouseTarget;this.mouseTarget=a;c&&c.onMouseEvent&&
c!=a&&(b=casual.copy(b,casual.StageEvent),b.type="mouseout",b.target=b.currentTarget=c,b.mouseX=this.mouseX,b.mouseY=this.mouseY,c.onMouseEvent(b))};a.prototype.__enterFrame=function(){if(!this._paused||this._pauseInNextFrame)this.dispatchEvent(new StageEvent(StageEvent.ENTER_FRAME)),this._paused&&!this._pauseInNextFrame||this._render(this.context,!0),0>=this._frameRate&&(clearInterval(this.__intervalID),this.__intervalID=null)};a.prototype.render=function(b,d){b||(b=this.context);d?this.clear(d.x,
d.y,d.width,d.height):this.clear();this.dragTarget&&(this.dragTarget.x=this.mouseX-this._dragMouseX,this.dragTarget.y=this.mouseY-this._dragMouseY);a.superClass.render.call(this,b);this._pauseInNextFrame&&(this._paused=!0,this._pauseInNextFrame=!1)};a.prototype.startDrag=function(b,a){this.dragTarget=b;var c=this.dragTarget.globalToLocal(this.mouseX,this.mouseY);this._dragMouseX=c.x;this._dragMouseY=c.y};a.prototype.stopDrag=function(){this.dragTarget=null};a.prototype.setCursor=function(b){this.canvas.style.cursor=
...
b._proxy(a,"arc");b._proxy(a,"quadraticCurveTo","curveTo");b._proxy(a,"bezierCurveTo");b._proxy(a,"rect");b._proxy(a,"createLinearGradient");b._proxy(a,"createRadialGradient");b._proxy(a,"createPattern");b.fillStyle=null;b.strokeStyle=null;b.fillAlpha=1;b.lineAlpha=1;b.lineWidth=1};a.prototype.lineStyle=function(b,a,c,e,f,g){this.lineWidth=this._context.lineWidth=b||1;this.strokeStyle=this._context.strokeStyle=a||"0";this.lineAlpha=c||1;void 0!=e&&(this._context.lineCap=e);void 0!=f&&(this._context.lineJoin=
f);void 0!=g&&(this._context.miterLimit=g);return this};a.prototype.beginLinearGradientFill=function(b,a,c,e,f,g){b=this.createLinearGradient(b,a,c,e);a=0;for(c=f.length;a<c;a++)b.addColorStop(g[a],f[a]);this.fillStyle=b;return this};a.prototype.beginRadialGradientFill=function(b,a,c,e,f,g,k,h){b=this.createRadialGradient(b,a,c,e,f,g);a=0;for(c=k.length;a<c;a++)b.addColorStop(h[a],k[a]);this.fillStyle=b;return this};a.prototype.beginBitmapFill=function(b,a){this.fillStyle=this.createPattern(b,a||
"");return this};a.prototype.beginFill=function(b,a){b&&(this.fillStyle=this._context.fillStyle=b);this.fillAlpha=a||1;return this};a.prototype.endFill=function(){this.strokeStyle&&(this._context.strokeStyle=this.strokeStyle,this._context.globalAlpha=this.lineAlpha,this._context.stroke());this.fillStyle&&(this._context.fillStyle=this.fillStyle,this._context.globalAlpha=this.fillAlpha,this._context.fill());return this};a.prototype.drawRect=function(b,a,c,e){this.beginPath();this.rect(b,a,c,e);this.closePath();
this.endFill();return this};a.prototype.drawRoundRect=function(b,a,c,e,f){return this.drawRoundRectComplex(b,a,c,e,f,f,f,f)};a.prototype.drawRoundRectComplex=function(b,a,c,e,f,g,k,h){this.beginPath();this.moveTo(b+f,a);this.lineTo(b+c-g,a);this.arc(b+c-g,a+g,g,-Math.PI/2,0,!1);this.lineTo(b+c,a+e-k);this.arc(b+c-k,a+e-k,k,0,Math.PI/2,!1);this.lineTo(b+h,a+e);this.arc(b+h,a+e-h,h,Math.PI/2,Math.PI,!1);this.lineTo(b,a+f);this.arc(b+f,a+f,f,Math.PI,3*Math.PI/2,!1);this.closePath();this.endFill();return this};
a.prototype.drawCircle=function(b,a,c){this.beginPath();this.arc(b+c,a+c,c,0,2*Math.PI,0);this.closePath();this.endFill();return this};a.prototype.drawEllipse=function(b,a,c,e){if(c==e)return this.drawCircle(b,a,c);c/=2;e/=2;var f=.5522847498307933*c,g=.5522847498307933*e;b+=c;a+=e;this.beginPath();this.moveTo(b+c,a);this.bezierCurveTo(b+c,a-g,b+f,a-e,b,a-e);this.bezierCurveTo(b-f,a-e,b-c,a-g,b-c,a);this.bezierCurveTo(b-c,a+g,b-f,a+e,b,a+e);this.bezierCurveTo(b+f,a+e,b+c,a+g,b+c,a);this.closePath();
this.endFill();return this};a.prototype.get=function(){return this._context.canvas};a.prototype.setSize=function(a,d){this._context.save();void 0!=a&&(this._context.canvas.width=a);void 0!=d&&(this._context.canvas.height=d);this._context.restore();return this};a.prototype.clear=function(){this._context.clearRect(0,0,this._context.canvas.width,this._context.canvas.height);this._context.restore();return this}})();(function(){var a=function(a){casual.DisplayObject.call(this);this.name=NameUtil.createUniqueName("Shape");this.mouseEnabled=!1;this.graphics=a||new casual.Graphics};casual.inherit(a,casual.DisplayObject);casual.Shape=a;a.prototype.render=function(a){a.drawImage(this.graphics.get(),0,0)}})();(function(){var a=function(a,d,c){casual.DisplayObject.call(this);this.name=NameUtil.createUniqueName("Text");this.text=a;this.color=d||"#000";this.font=c||"12px Arial";this.align="start";this.baseline="alphabetic";this.maxWidth=void 0;this.outline=!1;this.fontHeight=0};casual.inherit(a,casual.DisplayObject);casual.Text=a;a.prototype.render=function(a){this.text&&0!==this.text.length&&(this.outline?a.strokeStyle=this.color:a.fillStyle=this.color,a.font=this.font,a.textAlign=this.align,a.textBaseline=
this.baseline,this.fontHeight||(this.fontHeight=this.getFontHeight(a)),this.outline?a.strokeText(this.text,0,this.fontHeight,this.maxWidth):a.fillText(this.text,0,this.fontHeight,this.maxWidth))};a.prototype.getWidth=function(a){return this.text&&0!=this.text.length?a.measureText(this.text).width:0};a.prototype.getFontHeight=function(a){return a.measureText("\u554a").width}})();(function(){var a=function(b,d,c,e){casual.MovieClip.call(this);this.name=NameUtil.createUniqueName("Button");b&&this.setUpState(b);d&&this.setOverState(d);c&&this.setDownState(c);e&&this.setDisabledState(e);this.state=a.state.UP;this.enabled=!0;this.mouseChildren=!1;this.useHandCursor=!0;this.stop()};casual.inherit(a,casual.MovieClip);casual.Button=a;a.state={UP:"up",OVER:"over",DOWN:"down",DISABLED:"disabled"};a.prototype.setUpState=function(b){var d=new casual.Frame(b,a.state.UP);this.addFrameAt(d,
0);this.upState=b;return this};a.prototype.setOverState=function(b){var d=new casual.Frame(b,a.state.OVER);this.addFrameAt(d,1);this.overState=b;return this};a.prototype.setDownState=function(b){var d=new casual.Frame(b,a.state.DOWN);this.addFrameAt(d,2);this.downState=b;return this};a.prototype.setDisabledState=function(b){var d=new casual.Frame(b,a.state.DISABLED);this.addFrameAt(d,3);this.disabledState=b;return this};a.prototype.setEnabled=function(b){if(this.enabled==b)return this;(this.mouseEnabled=
this.enabled=b)?4==this.currentFrame&&this.gotoAndStop(a.state.UP):this.disabledState?this.gotoAndStop(a.state.DISABLED):this.gotoAndStop(a.state.UP);return this};a.prototype.setState=function(b){if(this.state!=b)switch(this.state=b,b){case a.state.OVER:case a.state.DOWN:case a.state.UP:this.enabled||(this.mouseEnabled=this.enabled=!0);this.gotoAndStop(b);break;case a.state.DISABLED:this.setEnabled(!1)}};a.prototype.onMouseEvent=function(b){if(this.enabled)switch(b.type){case "mousemove":if(this.onMouseOver&&
this.state!=a.state.OVER)b.type="mouseover",this.onMouseOver(b);else if(this.onMouseMove&&this.state==a.state.OVER)this.onMouseMove(b);this.overState&&this.state==a.state.UP&&this.setState(a.state.OVER);break;case "mouseout":this.upState&&this.setState(a.state.UP);this.onMouseOut&&(b.type="mouseout",this.onMouseOut(b));break;case "mousedown":this.downState&&this.setState(a.state.DOWN);if(this.onMouseDown)this.onMouseDown(b);break;case "mouseup":if(this.overState?this.setState(a.state.OVER):this.setState(a.state.UP),
this.onMouseUp)this.onMouseUp(b)}};a.prototype.onMouseMove=null;a.prototype.onMouseOver=null;a.prototype.onMouseOut=null;a.prototype.onMouseDown=null;a.prototype.onMouseUp=null})();(function(){function a(a,e){void 0!=window[a]&&(b[a]=window[a]);d[a]=window[a]=(e||casual)[a]}var b={},d={};casual.noConflict=function(){for(var a in d)void 0!=b[a]?window[a]=b[a]:delete window[a]};a("trace");a("EventBase");a("StageEvent");a("EventDispatcher");a("Matrix");a("Point");a("Rectangle");a("NameUtil");a("DisplayObject");a("DisplayObjectContainer");a("Graphics");a("Shape");a("Bitmap");a("Sprite");a("Frame");a("MovieClip");a("Stage");a("Text");a("Button")})();
